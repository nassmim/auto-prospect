...
CREATE TABLE "accounts" (
	...
	"fixed_phone_number" varchar(14),
	"phone_number" varchar(14),
	"whatsapp_phone_number" varchar(20),
	"sms_mobile_api_allowed" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "hunts" (
	...
	"status" "hunt_status" DEFAULT 'active' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "template_variables" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
ALTER TABLE "leads" ADD CONSTRAINT "leads_assigned_to_id_team_members_id_fk" FOREIGN KEY ("assigned_to_id") REFERENCES "public"."team_members"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "message_templates" ADD CONSTRAINT "message_templates_organization_id_fk" FOREIGN KEY ("account_id") REFERENCES "public"."accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_sent_by_id_fk" FOREIGN KEY ("sent_by_id") REFERENCES "public"."team_members"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE POLICY "enable all for account owners" ON "accounts" AS PERMISSIVE FOR ALL TO "authenticated" USING (
        (select auth.uid()) = "accounts"."id" ) WITH CHECK (
        (select auth.uid()) = "accounts"."id");--> statement-breakpoint
...
CREATE POLICY "enable read for authenticated users" ON "contacted_ads" AS PERMISSIVE FOR SELECT TO "authenticated" USING ("contacted_ads"."account_id" = (select auth.uid()));--> statement-breakpoint
CREATE POLICY "enable update for authenticated users" ON "contacted_ads" AS PERMISSIVE FOR UPDATE TO "authenticated" USING ("contacted_ads"."account_id" = (select auth.uid())) WITH CHECK ("contacted_ads"."account_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "enable read update and delete for the hunt owners" ON "hunts" AS PERMISSIVE FOR ALL TO "authenticated" USING ("hunts"."account_id" = (select auth.uid())) WITH CHECK ("hunts"."account_id" = (select auth.uid()));--> statement-breakpoint
...
CREATE POLICY "enable read for account owners" ON "lead_activities" AS PERMISSIVE FOR SELECT TO "authenticated" USING (exists (
        ...
        and l.account_id = (select auth.uid())
      ));--> statement-breakpoint
...
CREATE POLICY "enable all for account members" ON "lead_notes" AS PERMISSIVE FOR ALL TO "authenticated" USING (exists (
        select 1 from leads l
        where l.id = "lead_notes"."lead_id"
        and l.account_id = (select auth.uid()))) WITH CHECK (exists (
        select 1 from leads l
        where l.id = "lead_notes"."lead_id"
        and l.account_id = (select auth.uid())));--> statement-breakpoint
CREATE POLICY "enable all for account members" ON "lead_reminders" AS PERMISSIVE FOR ALL TO "authenticated" USING (exists (
        select 1 from leads l
        ...
        where l.id = "lead_reminders"."lead_id"
        and l.account_id = (select auth.uid())));--> statement-breakpoint
CREATE POLICY "enable insert for authenticated users" ON "leads" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (true);--> statement-breakpoint
CREATE POLICY "enable read for owners of the associated account" ON "leads" AS PERMISSIVE FOR SELECT TO "authenticated" USING ("leads"."account_id" = (select auth.uid()));--> statement-breakpoint
CREATE POLICY "enable update for owners of the associated account" ON "leads" AS PERMISSIVE FOR UPDATE TO "authenticated" USING ("leads"."account_id" = (select auth.uid())) WITH CHECK ("leads"."account_id" = (select auth.uid()));--> statement-breakpoint
CREATE POLICY "enable all for service role" ON "channel_priorities" AS PERMISSIVE FOR ALL TO "service_role" USING (true) WITH CHECK (true);--> statement-breakpoint
CREATE POLICY "enable all for owners of the associated account" ON "message_templates" AS PERMISSIVE FOR ALL TO "authenticated" USING ("message_templates"."account_id" = (select auth.uid())) WITH CHECK ("message_templates"."account_id" = (select auth.uid()));--> statement-breakpoint
CREATE POLICY "enable read for account owners" ON "messages" AS PERMISSIVE FOR SELECT TO "authenticated" USING (exists (
        select 1 from leads l
        where l.id = "messages"."lead_id"
        and l.account_id = (select auth.uid())
      ));--> statement-breakpoint
CREATE POLICY "enable insert for authenticated users" ON "messages" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (true);--> statement-breakpoint
CREATE POLICY "enable read for authenticated users" ON "template_variables" AS PERMISSIVE FOR SELECT TO "authenticated" USING (true);--> statement-breakpoint
CREATE POLICY "enable all for account owners" ON "team_members" AS PERMISSIVE FOR ALL TO "authenticated" USING ("team_members"."account_id" = (select auth.uid())) WITH CHECK ("team_members"."account_id" = (select auth.uid()));--> statement-breakpoint
CREATE POLICY "enable insert for authenticated users" ON "whatsapp_sessions" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (true);--> statement-breakpoint
