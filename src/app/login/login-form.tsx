'use client'
  ...
  export function LoginForm() {
    ...
    useEffect(() => {
      ...
      if (urlError) {
        // Google OAuth: user not registered
        if (urlError === 'access_denied' && errorDescription?.includes('Signups not allowed')) {   
          setError("Vous n'êtes pas encore inscrit, vous devez réserver un call avec notre équipe")
          return
        }
  ...
  text-green-700">
                Un lien de connexion a été envoyé à votre adresse email. Vérifiez votre boîte de   
  réception.
              </div>
            )}
            ...
            <form onSubmit={handleMagicLinkSubmit} className="space-y-4">
              <div>
                ...
                <input
                 ...
                 placeholder-gray-400 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900"  
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border
               border-gray-300 py-2.5 font-medium text-gray-700 hover:bg-gray-50"
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24">
                ...
                <path
                  fill="#EA4335"
                  d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99
