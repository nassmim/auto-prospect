...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: `${lead.ad.title} - Lead Details`,
      description: lead.ad.description || `Lead for ${lead.ad.title}`,
    };
  } catch {
    return {
...
export default async function LeadDetailPage({ params }: PageProps) {
  ...
  try {
    [lead, messagesList, activitiesList] = await Promise.all([
      getLeadDetails(id),
      getLeadMessages(id),
      ...
      <div className="border-b border-zinc-800/50 bg-zinc-950/95 px-6 py-3">
        <div className="mx-auto max-w-7xl">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-zinc-100">Lead #{id.slice(0, 8)}</span>
          </nav>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <section className="space-y-4 rounded-xl border border-zinc-800/50 bg-zinc-900/50 p-6">
              <h2 className="text-lg font-semibold text-zinc-100">
                Historique des messages ({messagesList.length})
              </h2>
          ...
          <div className="space-y-6">
            ...
            <section className="space-y-4 rounded-xl border border-zinc-800/50 bg-zinc-900/50 p-6">
              <h2 className="text-lg font-semibold text-zinc-100">
                Journal d'activité ({activitiesList.length})
              </h2>
