    ...
    >
      <CardContent className="p-3">
        ...
        <div className="flex gap-2">
          ...
          {hasWhatsApp && (
            <Badge variant="outline" className="gap-1 bg-green-900/30 text-green-400 border-green-500/20">
              <svg
                className="h-3 w-3"
                fill="currentColor"
                viewBox="0 0 24 24"
          ...
          {/* Platform badge */}
          <Badge variant="outline" className="ml-auto bg-blue-900/30 text-blue-400 border-blue-500/20">
            LBC
          </Badge>
        </div>
      </CardContent>
